<?php 
    ...
    "SELECT * FROM driver WHERE namadriver = '$namadriver'") or die(mysqli_error($con));         
    ...
    {              
        echo 
            '<script>                 
                ...
                window.location = "../page/loginDriver.php"                 
            </script>'; 
    }
    else
    { 
        ...
        if(password_verify($password, $user['password'])){ 
            ...
            echo 
                '<script>                     
                    alert("Login Success"); 
                    window.location = "../page/dashboardDriverPage.php"                     
                </script>'; 
            }
            else 
            {                 
