          ...
          <div class="card-header text-center fw-bold">Login</div> 
            <div class="card-body"> 
              ...
              <div class="mb-3 text-center"> 
                  <button class="btn btn-primary me-2" type="button" > 
                    <a class="text-light" style="text-decoration: none" href="../page/loginCustomer.php">Login Customer</a>                 
                </button> 
                </div> 
                <hr>
                <div class="mb-3 text-center"> 
                  <button class="btn btn-primary me-2" type="button" > 
                    <a class="text-light" style="text-decoration: none" href="../page/loginDriver.php">Login Driver</a>                 
                </button> 
                </div> 
                <hr>
                 <div class="mb-3 text-center"> 
                  <button class="btn btn-primary me-2" type="button" > 
                    <a class="text-light" style="text-decoration: none" href="../page/loginJabatan.php">Login Jabatan</a>                 
                </button> 
                </div>
                <hr>
                <div class="mb-3 text-center"> 
                  <button class="btn btn-primary me-2" type="button" > 
                    <a class="text-light" style="text-decoration: none" href="../page/loginPegawai.php">Login Pegawai</a>                 
                </button> 
                </div> 
                <hr>
                <div class="mb-3 text-center"> 
                  <button class="btn btn-primary me-2" type="button" > 
                    <a class="text-light" style="text-decoration: none" href="../page/loginPemilikMobil.php">Login Pemilik Mobil</a>                 
                </button> 
                </div> 
                <hr>
