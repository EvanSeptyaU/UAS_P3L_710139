    ...
    <div class="bg bg-light text-dark"> 
        <div class="container min-vh-100 d-flex align-items-center justify-content-center"> 
          <div class="card text-dark bg-light ma-5 shadow" style="min-width: 25rem;"> 
            <div class="card-header fw-bold">Login Pemilik Mobil</div> 
            <div class="card-body"> 
              <form action="../process/loginPemilikMobilProcess.php" method="post"> 
                <div class="mb-3"> 
                  <label for="exampleInputEmail1" class="form-label">Nama</label> 
                  <input class="form-control" id="namapemilikmobil" name="namapemilikmobil" aria-describedby="namapemilikmobil" placeholder="Nama Pemilik Mobil"> 
                </div> 
                <div class="mb-3"> 
                ...
                <div class="d-grid gap-2"> 
                  <button type="submit" class="btn btn-primary" name="loginPemilikMobil">Login</button> 
                </div> 
              </form> 
